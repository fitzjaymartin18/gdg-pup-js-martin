...
// Using let
let name = "Fitz Martin"; // Define a string here, e.g., "Juan Cruz"
let age = 20; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["eating", "sleeping", "coding", "playing sports", "reading", "playing instruments"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = "12 rules of life"; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
var colors = ["black", "teal", "maroon", "navy", "white"]; // Define an array here, e.g., ["red", "green", "blue"]
